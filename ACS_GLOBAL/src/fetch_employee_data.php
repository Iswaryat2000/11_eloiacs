...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST['projectID']) && isset($_POST['department'])) {
        ...
        // Create an SQL query to fetch data based on projectID and department
        $sql = "SELECT `ID`, `CODE`, `NAME`, `DEPARTMENT`, `WORKNATURE`, `JOININGDATE`, `BRANCH`, `BASIC`, `BANKNAME`, `ACCOUNTNO`, `IFSCCODE`, `SALARYACCOUNT`, `ESI_EPF`, `ESINO`, `EPFNO`, `STATUS`, `EXITDATE`, `MOBILE`, `DELSTATUS`, `TEAMLEADER`, `Livechange_date`, `userdeleted`, `Project_department`, `EMAIL`, `edited_by`
        FROM `employee_data`        
